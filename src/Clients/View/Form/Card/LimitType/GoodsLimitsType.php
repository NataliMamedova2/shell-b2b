...
final class GoodsLimitsType extends AbstractType
{
            ...
            ->add('id', EntityType::class, [
                ...
                'query_builder' => function (EntityRepository $entityRepository) {
                    ...
                    $qb
                        ...
                        ->setParameter('fuelType', FuelType::goods()->getValue())
