...
use App\Security\Provider\CabinetUserProvider;
...
class CabinetUserProviderTest extends TestCase
{
    /**
    ...
    public function setUp(): void
    {
        ...
        $this->provider = new CabinetUserProvider($this->repositoryMock->reveal());
    }
    ...
    {
        $result = $this->provider->supportsClass(CabinetTestUser::class);

        $this->assertEquals(false, $result);
    }
}

class CabinetTestUser implements UserInterface
{
    /**
