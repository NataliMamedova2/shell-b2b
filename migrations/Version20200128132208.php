 ...
 */
final class Version20200128132208 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Transaction write_off_type field';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP VIEW IF EXISTS view_company_transactions;');

        $this->addSql('ALTER TABLE card_transactions ALTER write_off_type TYPE INT USING write_off_type::integer');
        $this->addSql('ALTER TABLE card_transactions ALTER write_off_type DROP DEFAULT');
        ...
        $this->addSql(
            ...
            CREATE OR REPLACE VIEW view_company_transactions AS
                ...
                WHERE card_transactions.write_off_type IN (0, 1)
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE card_transactions ALTER write_off_type TYPE BOOLEAN');
        $this->addSql('ALTER TABLE card_transactions ALTER write_off_type DROP DEFAULT');
