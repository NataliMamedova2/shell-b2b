...
final class FuelListCest
{
    protected $basePath = '/api/v1/fuel/search';

    public function testGetFuelSuppliesNoSuppliesReturnEmptyList(ApiTester $I)
    {
        $I->authorizeAsAdmin();
    ...
    public function testGetFuelSuppliesHaveSuppliesWithEmptyPurseCodeReturnEmptyList(ApiTester $I)
    {
        $I->authorizeAsAdmin();

        $I->haveFuelList(4, ['purseCode' => 0]);
    ...
    public function testGetFuelSuppliesHaveFuelSuppliesReturnList(ApiTester $I)
    {
        $I->authorizeAsAdmin();
