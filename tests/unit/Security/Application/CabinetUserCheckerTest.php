...
use App\Security\Application\CabinetUserChecker;
use PHPUnit\Framework\TestCase;
use Symfony\Component\Security\Core\Exception\DisabledException;
use Symfony\Component\Security\Core\User\UserInterface;
use Tests\Unit\Clients\Domain\User\UserTest;

final class CabinetUserCheckerTest extends TestCase
{
    /**
     * @var CabinetUserChecker
     */
    private $checker;

    protected function setUp(): void
    {
        $this->checker = new CabinetUserChecker();
    }

    public function testCheckPreAuthIdentityNotInstanceofUser(): void
    {
        $identity = new CabinetTestUser();
    ...
    public function testCheckPreAuthUserIsNotActiveReturnException(): void
    {
        ...
        $identity = UserTest::createValidEntity();
        $identity->changeStatus(new Status(0));
